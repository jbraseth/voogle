# Voogle: Open Source Podcast Search Engine 🔍

🔱 **About This Project**

Voogle is a fork of [Voilib](https://github.com/unmonoqueteclea/voilib), which was created by Pablo Álvarez de Sotomayor Posadillo and archived in late 2024. This fork continues active development and maintenance of the project.

**Why fork?** While the original Voilib was archived, the core concept of semantic podcast search remains valuable. This fork aims to:
- Continue development and maintenance
- Modernize dependencies and architecture
- Extend functionality beyond the original scope

**Acknowledgment**: Voogle builds on the excellent foundation created by the Voilib project. We're grateful for Pablo's work in the early days of RAG-style systems.

---

Voogle offers **semantic search** in thousands of minutes of
high-quality transcriptions of podcasts. Just type your query and it
will find related content in thousands of episodes. Voogle also allows
users to index their own audio files.

![](https://github.com/jbraseth/voogle/actions/workflows/backend.yml/badge.svg)
[![License: GPL v3](https://img.shields.io/badge/License-GPLv3-blue.svg)](https://www.gnu.org/licenses/gpl-3.0)


![Voogle](./docs/voogle.gif)
...
- `VOOGLE_MANAGEMENT_PORT` (for management page: default `8501`)
- `VOOGLE_FRONTEND_PORT` (for frontend: default `80`)
- `VOOGLE_API_PORT` (for backend: default `81`)
...
Voogle with content. You can also check [first run tasks
...
## ❓ How it works
Voogle performs 4 main tasks: **collecting**, **transcribing**,
...
- **Collection**: Almost all public podcasts have an associated `RSS
  ...
  the **audio file**. Voogle uses those feeds to **collect and store**
  that metadata from the list of podcasts configured by the
  application admin. Additionally, Voogle can also index your own
  audio files.
...
- **Index**: Episodes transcripts are divided into **fragments of
  ...
  see the value currently used). Then, Voogle calculates the
...
- **Queries**: For each new user prompt, Voogle just needs to
...
## License
Voogle is licensed under the GNU GPLv3 license. See [COPYING](./COPYING).
